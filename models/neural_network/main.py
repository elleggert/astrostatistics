"""Script to quickly train models from the command line for development purposes"""
...
def main():
    parser = argparse.ArgumentParser(description='Base-Network using Average Systematics',
    ...
    parser.add_argument('-b', '--batch_size', default=16, metavar='', type=int,
